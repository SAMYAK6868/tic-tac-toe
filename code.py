...
def btnClick(buttons):
    ...
    if buttons["text"] == " " and bclick == True:
        ...
        tkinter.messagebox.showinfo("Tic-Tac-Toe", "You already Clicked this button press another one !")
...
button9 = Button(tk, text=' ', font='Times 20 bold', bg='red', fg='white', height=4, width=8, command=lambda: btnClick(button9))
